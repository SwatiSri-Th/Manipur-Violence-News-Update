...
export default function AdminTimesOfIndia({
  ...
  return (
    <div className="w-[90%] max-h-30 p-4 text-wrap text-black  rounded-xl flex flex-row  items-center justify-between shadow-[0_3px_10px_rgb(0,0,0,0.2)] transition-all">
      {image == null ? (
        <img
