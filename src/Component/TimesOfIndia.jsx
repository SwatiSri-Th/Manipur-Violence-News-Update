...
export default function TimesOfIndia({
  ...
  return (
    <a
      href={link}
      className="w-screen sm:w-[90%] max-h-30 p-4 text-wrap text-black  rounded-xl flex flex-col flex-wrap lg:flex-nowrap sm:flex-wrap sm:flex-col lg:flex-row items-center justify-between shadow-[0_3px_10px_rgb(0,0,0,0.2)] transition-all"
    >
      {image == null ? (
        <img
